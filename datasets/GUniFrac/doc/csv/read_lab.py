...
df = pd.read_csv("/Users/puoya.tabaghi/Downloads/clean/spherical/data/GUniFrac/doc/csv/label.csv")
...
print(categories)
directory = "/Users/puoya.tabaghi/Downloads/clean/spherical/data/GUniFrac/doc/csv/"
...
#         return 
#     else:
#         return np.random.randint(0, 3)  # Handle any other cases
