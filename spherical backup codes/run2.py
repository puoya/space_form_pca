        ...
        for func in functions:
            ...
            data_list.append({"d": d, "Method": func.__name__, 
                ...
                "ai_distortion":ai_distortion, "aitchison_dist":aitchison_dist,
                 "wass_distortion":wass_distortion, "wass_dist":wass_dist, 
                 "kl_distortion":kl_distortion,
                 "tv_distortion":tv_distortion, "tv_dist":tv_dist})
            print(cnt, "[", dist_distortion, ai_distortion, kl_distortion, tv_distortion, wass_distortion,sphere_dist,wass_dist, aitchison_dist,tv_dist, "]")
